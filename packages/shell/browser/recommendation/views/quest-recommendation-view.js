export const styles = `
  .dqr-root { --dqr-line: #d8e1e5; --dqr-muted: #78868d; --dqr-teal: #2b8091; --dqr-gold: #b78300; --dqr-alert: #c65a52; width: 700px; min-height: 720px; }
  ...
  .dqr-weight { color: #888; font-size: 10px; line-height: 1.45; }
  .dqr-toolbar-actions { display: flex; flex: 0 0 auto; gap: 6px; }
  .dqr-toolbar-button { min-width: 82px; min-height: 27px; padding: 0 10px; cursor: pointer; font: inherit; font-size: 11px; }
  ...
  .dqr-chapter-filter-note { color: var(--dqr-muted); font-size: 8px; }
  .dqr-chapter-filter-list { display: flex; flex-wrap: wrap; gap: 4px; }
  .dqr-filter-block { display: grid; gap: 4px; min-width: 0; }
  .dqr-control-label { color: var(--dqr-muted); font-size: 8px; font-weight: bold; letter-spacing: .05em; }
  .dqr-filter-list { display: flex; flex-wrap: wrap; gap: 4px; }
  .dqr-filter { min-height: 23px; padding: 2px 8px; border: 1px solid #8885; border-radius: 12px; background: transparent; color: inherit; cursor: pointer; font: inherit; font-size: 9px; }
  ...
  .dqr-sort { min-width: 115px; min-height: 25px; padding: 2px 24px 2px 7px; border: 1px solid #8885; border-radius: 3px; background: transparent; color: inherit; font: inherit; font-size: 9px; cursor: pointer; }
  .dqr-sort:disabled { cursor: wait; opacity: .5; }
  .dqr-visible-count { grid-column: 1 / -1; color: var(--dqr-muted); font-size: 8px; text-align: right; }
  ...
  .dqr-status { min-height: 18px; margin: 8px 0 3px; color: #888; font-size: 10px; }
  ...
  .dqr-eo-strip > div:first-child strong { color: #b78300; font-size: 10px; }
  .dqr-eo-strip > div:first-child span { margin-top: 2px; color: #888; font-size: 8px; line-height: 1.35; }
  .dqr-eo-list { display: flex; flex-wrap: wrap; align-items: center; gap: 4px; }
  .dqr-eo-list > span { display: inline-flex; gap: 4px; padding: 3px 5px; border: 1px solid #8884; border-radius: 9px; color: #888; font-size: 8px; }
  ...
  .dqr-message span { color: #888; font-size: 11px; }
  ...
  .dqr-group-heading > div:first-child strong { color: #b78300; font-size: 11px; }
  body.dark .dqr-group-heading > div:first-child strong { color: #fc0; }
  .dqr-group-heading > div:first-child span { color: #888; font-size: 8px; }
  .dqr-group-relations { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 3px; }
  .dqr-relation { display: inline-flex; align-items: center; min-height: 16px; padding: 1px 5px; border-radius: 8px; color: #fff; font-size: 8px; font-weight: bold; }
  ...
  .dqr-quest-icon { width: 49px; min-height: 21px; padding: 3px 2px; border-right: 4px solid #888; background: #1675c1; color: #fff; text-align: center; font: bold 10px/15px ui-monospace, SFMono-Regular, Menlo, monospace; }
  ...
  .dqr-heading h2 { margin: 0; overflow-wrap: anywhere; font-size: 11px; line-height: 1.4; }
  .dqr-tags { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 3px; }
  .dqr-tag { display: inline-flex; align-items: center; min-height: 17px; padding: 1px 5px; border-radius: 8px; font-size: 8px; }
  ...
  .dqr-cell-label { display: block; color: var(--dqr-muted); font-size: 8px; font-weight: bold; letter-spacing: .06em; }
  .dqr-rewards { display: grid; gap: 4px; margin-top: 5px; }
  .dqr-reward { display: flex; align-items: center; gap: 6px; min-height: 24px; padding: 3px 5px; border-left: 2px solid #8886; background: #8881; color: #777; font-size: 8px; font-weight: 600; line-height: 1.3; }
  ...
  .dqr-downstream > strong { color: #72509f; font-size: 8px; }
  body.dark .dqr-downstream > strong { color: #c89cff; }
  .dqr-downstream article { padding: 4px; background: #7b65a50c; }
  .dqr-downstream header { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: baseline; gap: 4px; font-size: 8px; line-height: 1.35; }
  ...
  .dqr-downstream header em { color: var(--dqr-muted); font-size: 7px; font-style: normal; white-space: nowrap; }
  .dqr-downstream .dqr-rewards { margin-top: 3px; }
  .dqr-guidance-reasons { display: grid; gap: 3px; margin-top: 5px; }
  .dqr-guidance-reasons span { padding: 2px 5px; border-left: 2px solid #a36b22; background: #a36b2212; color: #8a5b21; font-size: 8px; line-height: 1.35; }
  body.dark .dqr-guidance-reasons span { color: #d7a45f; }
  .dqr-description { margin: 5px 0 0; color: #777; font-size: 9px; line-height: 1.5; }
  body.dark .dqr-description { color: #aaa; }
  .dqr-deadline { margin-top: 8px; color: var(--dqr-muted); font-size: 8px; font-weight: 600; line-height: 1.45; }
  ...
  .dqr-priority span { color: var(--dqr-muted); font-size: 8px; }
  .dqr-priority strong { font-size: 11px; }
  ...
  .dqr-stage-heading strong { font: 8px ui-monospace, SFMono-Regular, Menlo, monospace; }
  .dqr-stage-heading > span:last-child { color: #888; font-size: 8px; }
  .dqr-stage-participants { display: grid; gap: 3px; margin-top: 5px; }
  .dqr-stage-participants > span { padding: 3px 5px; border-left: 2px solid #2b8091; background: #2b80910d; font-size: 8px; line-height: 1.35; }
  ...
  .dqr-stage-objectives { display: grid; grid-template-columns: 55px minmax(0, 1fr); gap: 6px; margin-top: 5px; font-size: 9px; line-height: 1.45; }
  .dqr-stage-objectives > span { color: #888; }
  .dqr-synergy-steps { margin: 4px 0 0; padding-left: 17px; color: #777; font-size: 9px; line-height: 1.5; }
