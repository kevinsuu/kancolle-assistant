export const en = {
  ...
  'quest.help.whatAnswer':
    'After a manual live sync, filter by quest type and select Chapters 1–7 for sortie quests. Non-sortie quests always remain at the top.',
  ...
  'quest.type.expedition': 'Expedition',
  'quest.type.arsenal': 'Arsenal',
  'quest.type.modernization': 'Modernization',
  'quest.type.other': 'Other',
  ...
  'quest.filter.emptyDetail':
    'Adjust the quest type, chapter, or reward filters. Chapter filters only affect sortie quests.',
  'quest.sort.label': 'Sort',
  'quest.sort.priorityDesc': 'Recommendation high → low',
  ...
  'quest.synergy.alternativesTitle': 'Alternative co-completion plan',
  'quest.synergy.alternativesHint': 'Choose this instead; it does not combine every linked quest.',
